...
#SBATCH -a 1 # TODO: change job array id

scene="crytek_sponza" # TODO: change scene
...
logfile="logs/${scene}/cvvdp_edited_${SLURM_ARRAY_TASK_ID}.log"
...
filename="${directory_name}/${scene}_edited_${SLURM_ARRAY_TASK_ID}.txt"
touch "$filename"
python runcvvdp.py $SLURM_ARRAY_TASK_ID $scene > "$filename" 2>&1
